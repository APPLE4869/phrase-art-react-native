...
const imageDefaultSize = 21;
const imageMaxSize = 27;

export default class FavoriteWithCount extends React.Component<Props, State> {
  ...
  render() {
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={1}
        style={{ flexDirection: "row", alignItems: "center", justifyContent: "flex-end", width: 42 }}
      >
        <Animated.Image
